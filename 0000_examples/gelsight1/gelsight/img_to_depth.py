...
#         self.bins = bins  # list[0]
#         self.GradMag = GradMag  # list[1]
#         self.GradDir = GradDir  # list[2]
#         self.GradX = GradX  # list[3]
#         self.GradY = GradY  # list[4]
#         self.Zeropoint = Zeropoint  # list[5]
#         self.Scale = Scale  # list[6]
#         self.Pixmm = Pixmm  # list[7]
#         self.FrameSize = FrameSize  # list[8]

class ImageToDepth(object):

    def __init__(self):
        self.camera_parameter = pickle.load(open('calib1.pkl', 'rb'))
        self.lookup_table = pickle.load(open('result1.pkl', 'rb'))
        self.border = 30
        ...
        self.f0 = f0[102: 385, 183: 478, : ]
        # self.pix_to_mm = 2.5 * 9 / 263.5
        self.pix_to_mm = 2.5*9/283
